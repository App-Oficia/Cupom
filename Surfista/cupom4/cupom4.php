    ...
    <body class="fundoWhite">
        ...
        <div id="produto1" style="width: 100%;">
            <div style="text-align: center; display: flex; justify-content: center; flex-direction: column; align-content: center; flex-wrap: wrap; position: relative;">
                ...
                <div class="container" id="container">
                    ...
                    <div class="cards">
                            ...
                            <img style="width: 80%;" src="images/60.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-1" value="71677386">
                        </label>
                                                <label class="card" for="item-2" id="song-2">
                            <img style="width: 80%;" src="images/86.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-2" value="47527143">
                        </label>
                                                <label class="card" for="item-3" id="song-3">
                            <img style="width: 80%;" src="images/71.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-3" value="31275132">
                        </label>
                                                <label class="card" for="item-4" id="song-4">
                            <img style="width: 80%;" src="images/65.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-4" value="33564482">
                        </label>
                                                <label class="card" for="item-5" id="song-5">
                            <img style="width: 80%;" src="images/25.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-5" value="42712113">
                        </label>
                                                <label class="card" for="item-6" id="song-6">
                            <img style="width: 80%;" src="images/9.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-6" value="74556317">
                        </label>
                                                <label class="card" for="item-7" id="song-7">
                            <img style="width: 80%;" src="images/38.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-7" value="98698757">
                        </label>
                                                <label class="card" for="item-8" id="song-8">
                            <img style="width: 80%;" src="images/24.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-8" value="28617816">
                        </label>
                                                <label class="card" for="item-9" id="song-9">
                            <img style="width: 80%;" src="images/4.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-9" value="44276664">
                        </label>
            ...
            <div id="codigoBarras" class="coolinput" style="margin-top: 275px; display: none;">
                ...
                <form action="https://reidocha.com/cupom/cupom5/cupom5.php" method="POST" id="formCupom">     
                    <label for="input" id="textoCodigoBarras" class="text">CUPOM</label>
                    <input style="font-size: 16px;" type="text" placeholder="Digite os 8 digitos do CUPOM" name="codigoBarrasDigitado" id="codigoBarrasDigitado" class="input" inputmode="numeric" autocomplete="off" required="" onkeyup="validacaoCodigoBarras4()">
