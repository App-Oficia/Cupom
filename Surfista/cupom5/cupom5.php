    ...
    <body class="fundoWhite">
        ...
        <div id="p1" style="background-color: #FFFFFF; padding: 15px 0 18px 0;">
            ...
            <div class="boxSaldo">
                ...
                <p class="valorSaldo">R$ <span class="saldoAtualizado">293.97</span></p>
            </div>
        ...
        <div id="produto1" style="width: 100%;">
            <div style="text-align: center; display: flex; justify-content: center; flex-direction: column; align-content: center; flex-wrap: wrap; position: relative;">
                ...
                <div class="container" id="container">
                    ...
                    <div class="cards">
                            ...
                            <img style="width: 80%;" src="images/56.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-1" value="79891578">
                        </label>
                                                <label class="card" for="item-2" id="song-2">
                            <img style="width: 80%;" src="images/8.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-2" value="55469718">
                        </label>
                                                <label class="card" for="item-3" id="song-3">
                            <img style="width: 80%;" src="images/19.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-3" value="31968178">
                        </label>
                                                <label class="card" for="item-4" id="song-4">
                            <img style="width: 80%;" src="images/22.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-4" value="43114261">
                        </label>
                                                <label class="card" for="item-5" id="song-5">
                            <img style="width: 80%;" src="images/15.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-5" value="95792996">
                        </label>
                                                <label class="card" for="item-6" id="song-6">
                            <img style="width: 80%;" src="images/40.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-6" value="55938874">
                        </label>
                                                <label class="card" for="item-7" id="song-7">
                            <img style="width: 80%;" src="images/94.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-7" value="52328144">
                        </label>
                                                <label class="card" for="item-8" id="song-8">
                            <img style="width: 80%;" src="images/84.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-8" value="81795889">
                        </label>
                                                <label class="card" for="item-9" id="song-9">
                            <img style="width: 80%;" src="images/76.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-9" value="66777793">
                        </label>
                                                <label class="card" for="item-10" id="song-10">
                            <img style="width: 80%;" src="images/29.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-10" value="46858886">
                        </label>
                                                <label class="card" for="item-11" id="song-11">
                            <img style="width: 80%;" src="images/44.jpg">
                            <input type="hidden" name="codigoEscolhido" id="codigoEscolhido-11" value="69461273">
                        </label>
                                            </div>
            ...
            <div id="codigoBarras" class="coolinput" style="margin-top: 275px; display: none;">
                ...
                <form action="https://reidocha.com/cupom/cupom6/cupom6.php" method="POST" id="formCupom">     
                    <label for="input" id="textoCodigoBarras" class="text">CUPOM</label>
                    <input style="font-size: 16px;" type="text" placeholder="Digite os 8 digitos do CUPOM" name="codigoBarrasDigitado" id="codigoBarrasDigitado" class="input" inputmode="numeric" autocomplete="off" required="" onkeyup="validacaoCodigoBarras5()">
        ...
        <script>
            // BACK REDIRECT
            var urlBackRedirect = 'saqueFinal.php'; // lembre-se de usar a url sem espaços
